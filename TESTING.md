...
| Description | Steps | Expected Result | Actual Result |
| -------------|-------|-----------------|---------------|
| User Login | Log in using credentials | User receives welcome message  | ✅ |
| User Logout | Log out by clicking the Logout button | User receives goodbye message  | ✅ |
| Cosplay Submission | Submit a cosplay using the form | User receives message informing them the submission has gone to an admin for approval  | ✅ |
| Cosplay (re)Submission | resubmit a cosplay using the form | User receives message informing them the submission has been updated and is going to an admin for approval  | ✅ |
| Cosplay Deletion | Delete a cosplay using the button | User receives a popup asking them if they wish to go through with deletion  | ✅ |
